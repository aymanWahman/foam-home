...
const Header = () => {
  ...
  return (
    ...
    <ul className='flex mt-1  md:mr-3 gap-4 md:gap-12 items-center text-gray-400 '>
        ...
        <li className='text-sm hover:text-lg md:text-2xl hover:md:text-3xl hover:font-bold'><Link href="/products">Products</Link></li>
        <li className='text-sm hover:text-lg md:text-2xl hover:md:text-3xl hover:font-bold'><Link href="/about">About</Link></li>
        {theme === 'dark' 
        ? 
